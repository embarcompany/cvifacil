...
export async function POST(request: Request) {
  ...
  const row = {
    ...
    dclid: getString(payload, "dclid"),
    msclkid: getString(payload, "msclkid"),
    ttclid: getString(payload, "ttclid"),
    twclid: getString(payload, "twclid"),
    rdt_cid: getString(payload, "rdt_cid"),
    igshid: getString(payload, "igshid"),
    ctwa_clid: getString(payload, "ctwa_clid"),
    irclickid: getString(payload, "irclickid"),
    epik: getString(payload, "epik"),
    wamid: getString(payload, "wamid"),
    tintim_fbid: getString(payload, "tintim_fbid"),
